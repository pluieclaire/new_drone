...
<script>
    ...
    function setPreviewForPastUpload(){
    	var pastUpload = "";
    	var uploadFiles = "";
		...
		for (var i = 0; i < parsed.length - 1;i++){
			pastUpload += "<div class=\"preview-box col-lg-3 m-2 \" value=\"" + "past" + i +"\">";
		...
		var totalUploadFiles = "<input type='hidden' id='storedFileName' name='storedFileName' />";
    	$("#preview").append(pastUpload);
    }
    
    function deletePreviewForPast(obj) {
        var imgNum = obj.attributes['value'].value;
        //delete files[imgNum];
        $("#preview .preview-box[value=" + "past" + imgNum + "]").remove();
        //resizeHeight();
    }
