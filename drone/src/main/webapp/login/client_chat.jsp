...
<script type="text/javascript">
	...
	w = new WebSocket("ws://localhost:8800/finalsocket/broadcasting?nickname=<%=nickname%>");
	w.onopen = function() {
...
<style>
.container{max-width:1170px; margin:auto; float: center;}
img{ max-width:100%;}
.inbox_people {
...
<div class="messaging">
        ...
        <div class="mesgs">
          ...
          <div class="type_msg">
            <div class="input_msg_write">
              <input type="text" class="write_msg" id="input" onkeyup="enterkey();" placeholder="메세지 입력하짜" />
      ...
      <p class="text-center top_spac"> Design by <a target="_blank" href="#">Sgo_Lee</a></p>
