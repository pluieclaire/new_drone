...
<body>
	<div class="container">
		<div class="row mt-1 mb-1 pt-5"
			style="background-image: url('${pageContext.request.contextPath}/resources/img/g3.jpg'); background-size: cover;">
...
<form id="guide_write">
	...
	<input type="hidden" class="form-control" name="num" id="num" value="<%=guideVO.getNum()%>"/>
    <input type="hidden" class="form-control" name="id" id="id" value="<%=guideVO.getId()%>"/>
    	
	
	<div class="form-group row">
    	<label for="title" class="col-sm-2 col-form-label">이름</label>
    	<div class="col-sm-10">
      	<input type="text" class="form-control" name="nickname" id="nickname" value="<%=guideVO.getNickname() %>" readonly/>
    	</div>
  	</div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="title" id="title" placeholder="<%=guideVO.getTitle()%>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="content" class="col-sm-2 col-form-label">내용</label>
    <div class="col-sm-10" style="height:400px;">
      <textarea class="form-control" rows="16" name="body" id="body" placeholder="내용수정"><%=guideVO.getBody()%></textarea>
    </div>
  </div>
